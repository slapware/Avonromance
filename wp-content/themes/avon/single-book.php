...
$book_author = getAuthorNameByID($aid);
...
<div class="group shadow">
	...
	<div style="overflow:visible" class="span6 post">
		...
		<h3><a href="<?php echo get_permalink($book_author->ID); ?>"><?php echo $book_author; ?></a></h3>
		<br>
		...
		<div class="span3">
			...
			$posttags = get_the_tags();
 			if ($posttags) {
 			  ...
 			  if($isin === 0) {
 			  	$author = substr($tag->name, 7);
				break;
				}
 			  }
 			}
 			else {
 			$author = get_post_meta( $post->ID, "BookAuthor", true );
 			}
			...
			<li><a href="<?php echo get_permalink($post_book_author[0]->ID); ?>">By <?php echo get_post_meta( get_the_ID(), 'BookAuthor', true); ?></a></li>
			<?php } else{ ?>
			<li><a href="<?php echo get_permalink($post_book_author[0]->ID); ?>">By <?php echo $author; ?></a></li> -->
			<?php } ?>
...
//			$book_author = get_field('book_author');
			$auth_id = get_field('book_author');
			$book_author = get_post((int)$auth_id[0]);
//			var_dump($book_author);
			...
			<div class="book">
				...
				<!-- SLAP fix -->
				<li><a href="<?php echo get_permalink($book_author->ID);?>">By <?php echo $book_author->post_title;?></a></li>
				<li><a href="<?php echo get_permalink($book_id); ?>">7 People Talking About</a></li>
				<!--
