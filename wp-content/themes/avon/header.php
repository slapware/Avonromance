...
<meta charset="UTF-8">
<meta content="Avon Romance" property="og:title">
<meta content="Avon Romance" property="twitter:title">
...
<!--<link href="http://www.avonromance.com/" rel="canonical">-->
<link href="<?php $_SERVER['REQUEST_URI']?>" rel="canonical">
...
<?php if (is_page('impulse') || is_page('impulse-welcome') || is_page('impulse-editors') || is_page('impulse-faq') || is_page('impulse-reviews')) { ?>
    <link href="<?php bloginfo('template_directory') ?>/css/impulse-style.css" rel="stylesheet" />
    <script src="<?php echo get_template_directory_uri(); ?>/js/impulse.js"></script>
<?php } ?>
</head>
